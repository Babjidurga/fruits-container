...
class Counter extends Component{
    ...
    render(){
        ...
        return(
            <div className='main'>
        <div className='home'>
            <h1 className='main-head'>Bob ate <span>{mango}</span> mangoes, <span>{banana}</span> bananas</h1>
            <div className='container'>
            <div className='fruit-contianer'>
                <img src = "https://assets.ccbp.in/frontend/react-js/mango-img.png " alt = "mango" className='image'/>
                <  button className = "fruit-button" onClick={this.onMango}>Eat Mango</button>
            </div>
            <div className='fruit-contianer'>
                <img src = "https://assets.ccbp.in/frontend/react-js/banana-img.png " alt="banana" className='image'/>
                <  button className = "fruit-button" onClick={this.onBanana}>Eat Banana</button>
            </div>
            </div>
            </div>
        </div> )
